          ...
          <div className="col-lg-4 col-sm-6">
            <div className="position-relative rounded-16 overflow-hidden z-1 p-32">
              ...
              <div className="flex-between flex-wrap gap-16">
                <div className="">
                  <span className="text-heading text-sm mb-8">Packing & Packaging Materials</span>
                  <h6 className="mb-0">Ensure secure shipping with durable, eco-friendly boxes,
                  tapes, and cushioning materials.</h6>
                  <Link
                    to="/shop"
